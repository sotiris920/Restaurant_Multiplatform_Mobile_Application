  ...
  $scope.addFavorite = function (index) {
    ...
    $ionicPlatform.ready(function () {
      $cordovaLocalNotification.schedule({
        id: 1,
        title: "conFusion : Added Favorite",
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', '$ionicModal', 'favoriteFactory', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, $ionicModal, favoriteFactory,  $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
  ...
  // 'dish' is a Resolve implemented in app.js dishdetails
	$scope.dish = dish;
  ...
  $ionicPopover.fromTemplateUrl('templates/dish-detail-popover.html', {
   ...
   $scope.$on('$destroy', function() {
      $scope.dishDetailPopOverForm.remove();
   });

        //---- Add Favorite from Popover ----
   $scope.addFavorite = function(index){
      console.log("index is " + index);
      favoriteFactory.addToFavorites(index);
      ...
      $ionicPlatform.ready(function () {
       ...
       $cordovaToast
         .show('Added Favorite '+$scope.dish.name, 'short', 'bottom')
         .then(function (success) {
           // success
         }, function (error) {
           // error
  ...
  // Triggered in the reserve modal to close it
  $scope.closeAddCommentForm = function() {
...
.controller('AboutController', ['$scope', 'leaders', 'baseURL', function($scope, leaders, baseURL) {
  ...
  .controller('FavoritesController', ['$scope', 'dishes', 'favorites', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicPlatform', '$cordovaVibration', function ($scope, dishes, favorites, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicPlatform, $cordovaVibration) {
    ...
    // 'favorites' and 'dishes' are Resolves implemented in app.js favorites state
